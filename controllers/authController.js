...
const signToken=id=>{
  ...
  // cookie generated by the server to the user and when they accept it it store and send tothe server for the future requests.
...
// to escape from denial of service or brute force attacks
// ratelimiter will implemented as a global middleware function
// count the number of requests come from  one  ip when there are two requests it blocks the 
...
exports.protect=catchAsync( async(req,res,next)=>{
      ...
      //2 validate token or not verification
